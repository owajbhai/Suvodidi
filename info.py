...
BOT_TOKEN = environ.get('BOT_TOKEN', "7396052741:AAEuibdSMLZge-ZDkEf4Drzdv3pAes2wNDA")
...
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1002046895970'))  
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002217352991'))  
...
AUTH_REQ_CHANNEL = int(environ.get('AUTH_REQ_CHANNEL', '-1002046895970'))
...
URL = "https://dull-sacha-wajshaikh-e5db738c.koyeb.app/".format(FQDN) if ON_HEROKU or NO_PORT else "https://{}/".format(FQDN, PORT)
...
if HAS_SSL:
    ...
    URL = "http://dull-sacha-wajshaikh-e5db738c.koyeb.app/".format(FQDN)
