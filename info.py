...
BOT_TOKEN = environ.get('BOT_TOKEN', "s7g0b2e.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")

CACHE_TIME = int(environ.get('CACHE_TIME', 300))
USE_CAPTION_FILTER = bool(environ.get('USE_CAPTION_FILTER', True))

PICS = (environ.get('PICS', 'https://i.ibb.co/PZpBxDgQ/e5680ca81641.jpg')).split() 
NOR_IMG = environ.get("NOR_IMG", "https://i.ibb.co/PZpBxDgQ/e5680ca81641.jpg")
MELCOW_VID = environ.get("MELCOW_VID", "https://i.ibb.co/PZpBxDgQ/e5680ca81641.jpg")
...
FSUB_IMG = (environ.get('FSUB_IMG', 'https://i.ibb.co/PZpBxDgQ/e5680ca81641.jpg')).split() 
...
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://xogac48540:ozV5Cec4SgMgg0Yc@cluster0.s7g0b2e.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://movoneg711:ozV5Cec4SgMgg0Yc@cluster0.qaixact.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002310160204')).split()]
